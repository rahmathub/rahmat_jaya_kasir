...
$h1 = mysqli_query($c, "SELECT * FROM peminjaman");
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    $get = mysqli_query($c, "SELECT * FROM peminjaman p, produk pr WHERE p.idbarang=pr.idproduk ORDER BY idpeminjaman DESC");

                                    while ($p=mysqli_fetch_array($get)) {
                                        $idpe = $p['idpeminjaman'];
                                        $idb = $p['idbarang'];
                                        $tanggal = $p['tanggalpinjam'];
                                        $namabarang = $p['namaproduk'];
