                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form method="post">
                                                        <div class="modal-body">
                                                            ...
                                                            <input type="number" name="qty" class="form-control mt-2" placeholder="Stock" value="<?= $stockawal; ?>">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="submit" class="btn btn-success" name="ubahdatapesanan">Ya</button>
