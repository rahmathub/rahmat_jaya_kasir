...
$h1 = mysqli_query($c, "SELECT * FROM pesanan2");
...
<html lang="en">
    <head>
        ...
        <title>Data Pesanan Kolono TImur</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Data Pesanan Kolono Timur</h1>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    $get = mysqli_query($c, "SELECT * FROM pesanan2 p, pelanggan2 pl WHERE p.idpelanggan2=pl.idpelanggan2");
                                    ...
                                    while ($p=mysqli_fetch_array($get)) {
                                        ...
                                        // hitung jumlah
                                        $hitungjumlah = mysqli_query($c, "SELECT * FROM detailpesanan2 WHERE idpesanan2='$idorder'");
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?= $jumlah;  ?></td>
                                            <td><a href="view2.php?idp=<?= $idorder; ?>" class="btn btn-primary" target="blank">Tampilkan</a>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form method="post">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="submit" class="btn btn-success" name="hapusorder2">Hapus</button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="post">
                    <div class="modal-body">
                        ...
                        <select name="idpelanggan" class="form-control">
                            ...
                            while($pl=mysqli_fetch_array($getpelanggan)){
                                $namapelanggan = $pl['namapelanggan2'];
                                $idpelanggan = $pl['idpelanggan2'];
                                $alamat = $pl['alamat2'];
                    ...
                    <!-- Modal footer -->
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-success" name="tambahpesanan2">Submit</button>
                        <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
