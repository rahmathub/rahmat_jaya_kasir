                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form method="post" enctype="multipart/form-data">
                                                        <div class="modal-body">
                                                            ...
                                                            <br>
                                                            <input type="text" name="diskon" class="form-control" placeholder="Harga Diskon" required value="<?= $diskon; ?>">
                                                            <br>
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="submit" class="btn btn-success" name="editbarangstock">Submit</button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="post" enctype="multipart/form-data">
                    ...
                    <!-- Modal footer -->
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-success" name="tambahbarangstock">Submit</button>
                        <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
