...
<head>
    ...
    <title>Toko Bangunan Rahmat Jaya</title>
...
<body>
    ...
    <div class="container">
        ...
        <!-- Carousel bisa di pasangkan iklan -->
        <div id="demo" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="qq(1).jpg" alt="Los Angeles" class="d-block" style="width:100%; height: 400px;">
                    <div class="carousel-caption">
                        <h3>PERTASHOP KOLONO</h3>
                        <p>LOKASI KAMI TERDEKAT</p>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="qq(2).jpg" alt="Chicago" class="d-block" style="width:100%; height: 400px;">
                    <div class="carousel-caption">
                        <h3>SKOP TERLARIS KAMI</h3>
                        <p>COCOK UNTUK TUKANG BANGUNAN</p>
                    </div> 
                </div>
                <div class="carousel-item">
                    <img src="qq(3).jpg" alt="New York" class="d-block" style="width:100%; height: 400px;">
                    <div class="carousel-caption">
                        <h3>PAKU TERLARIS KAMI</h3>
                        <p>SEGALA UNTUK MEMBANGUN BISA DIPAKAI</p>
                    </div>  
                </div>
            </div>
        ...
        <div class="rakjualan">
            ...
            <?php  
            $get = mysqli_query($c, "SELECT * FROM produk LIMIT 8");
            ...
            ?>
            <!-- menu bawah toko kolono timur -->
            <div class="menuselengkapnya">
                <a href="area_kolono_timur.php"><i class="bi bi-chevron-double-right"> Lihat Selengkapnya toko ini</i></a>
            </div>
        </div>
        <br>
        ...
        <div class="rakjualan">
            ...
            <?php  
            $get = mysqli_query($c, "SELECT * FROM produk2 LIMIT 8");
            while ($p=mysqli_fetch_array($get)) {
            ...
            ?>
            <!-- menu bawah toko kolono -->
            <div class="menuselengkapnya">
                <a href="area_kolono.php"><i class="bi bi-chevron-double-right"> Lihat Selengkapnya toko ini</i></a>
            </div>
        </div>
        <br>
