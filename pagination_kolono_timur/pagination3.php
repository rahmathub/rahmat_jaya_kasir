...
<body>
    ...
    <div class="container">
        ...
        <div class="rakjualan">
            ...
            <?php  
            $get = mysqli_query($c, "SELECT * FROM produk WHERE deskripsi='NAT TEHEL' LIMIT 20");
            ...
            <!-- MENU MESIN KATINTING -->
            <div class="judularea">
                <h3>MESIN KATINTING</h3>
                <hr>
            </div>
            <?php  
            $get = mysqli_query($c, "SELECT * FROM produk WHERE deskripsi='MESIN KATINTING' LIMIT 4");
            while ($p=mysqli_fetch_array($get)) {
                $namaproduk = $p['namaproduk'];
                $deskripsi = $p['deskripsi'];
                $hargaproduk = $p['harga'];
            ...
            <?php  
            $get = mysqli_query($c, "SELECT * FROM produk WHERE deskripsi='MESIN SENSO' LIMIT 4");
            while ($p=mysqli_fetch_array($get)) {
                $namaproduk = $p['namaproduk'];
                $deskripsi = $p['deskripsi'];
                $hargaproduk = $p['harga'];
            ...
            <?php  
            $get = mysqli_query($c, "SELECT * FROM produk WHERE deskripsi='RANTE SENSO' LIMIT 4");
            while ($p=mysqli_fetch_array($get)) {
                $namaproduk = $p['namaproduk'];
                $deskripsi = $p['deskripsi'];
                $hargaproduk = $p['harga'];
            ...
            <!-- JENIS-JENIS RACUN RUMPUT -->
            <div class="judularea">
                <h3>RACUN RUMPUT</h3>
                <hr>
            </div>
            <?php  
            $get = mysqli_query($c, "SELECT * FROM produk WHERE deskripsi='RACUN RUMPUT' LIMIT 12");
            while ($p=mysqli_fetch_array($get)) {
                $namaproduk = $p['namaproduk'];
                $deskripsi = $p['deskripsi'];
                $hargaproduk = $p['harga'];
        ...
        <div>
                <ul class="pagination justify-content-center">
                    <li class="page-item"><a class="page-link" href="pagination2.php">Previous</a></li>
                    <li class="page-item"><a class="page-link" href="../area_kolono_timur.php">1</a></li>
                    <li class="page-item"><a class="page-link" href="pagination2.php">2</a></li>
                    <li class="page-item disabled"><a class="page-link" href="pagination3.php">3</a></li>
                    <li class="page-item disabled"><a class="page-link" href="pagination4.php">Next</a></li>
                </ul>
        </div>
        <br>
        <br>
