...
<body>
    ...
    <div class="container">
        ...
        <div class="rakjualan">
            ...
            <?php  
            $get = mysqli_query($c, "SELECT * FROM produk WHERE deskripsi='BAHAN BANGUNAN' LIMIT 4");
            ...
            ?>
            <!-- menu selengkapnya di BAHAN BANGUNAN -->
            <div class="menuselengkapnya">
                <a href="menu_selengkapnya_kl/bahan_bangunan.php"><i class="bi bi-chevron-double-right"> Lihat Lebih Lengkap</i></a>
            </div>
            <br>
            ...
            <?php  
            $get = mysqli_query($c, "SELECT * FROM produk WHERE deskripsi='ALAT TUKANG' LIMIT 4");
            while ($p=mysqli_fetch_array($get)) {
                $namaproduk = $p['namaproduk'];
                $deskripsi = $p['deskripsi'];
                $hargaproduk = $p['harga'];
            ...
            ?>
            <br>
            <!-- menu selengkapnya ALAT TUKANG -->
            <div class="menuselengkapnya">
                <a href="menu_selengkapnya_kl/alat_tukang.php"><i class="bi bi-chevron-double-right"> Lihat Lebih Lengkap</i></a>
            </div>
            <br>

            <!-- JENIS PAKU -->
            <div class="judularea">
                <h3>JENIS-JENIS PAKU</h3>
                <hr>
            </div>
            <?php  
            $get = mysqli_query($c, "SELECT * FROM produk WHERE deskripsi='PAKU' LIMIT 4");
            while ($p=mysqli_fetch_array($get)) {
                $namaproduk = $p['namaproduk'];
                $deskripsi = $p['deskripsi'];
                $hargaproduk = $p['harga'];
            ...
            ?>
            <br>
            <!-- menu selengkapnya JENIS-JENIS PAKU -->
            <div class="menuselengkapnya">
                <a href="menu_selengkapnya_kl/jenis_paku.php"><i class="bi bi-chevron-double-right"> Lihat Lebih Lengkap</i></a>
            </div>
            <br>

            <!-- JENIS-JENIS LANTAI -->
            <div class="judularea">
                <h3>JENIS-JENIS LANTAI</h3>
                <hr>
            </div>
            <?php  
            $get = mysqli_query($c, "SELECT * FROM produk WHERE deskripsi='LANTAI' LIMIT 16");
            while ($p=mysqli_fetch_array($get)) {
                $namaproduk = $p['namaproduk'];
                $deskripsi = $p['deskripsi'];
                $hargaproduk = $p['harga'];
            ...
            ?>
            <br>
            <!-- menu selengkapnya JENIS-JENIS LANTAI -->
            <div class="menuselengkapnya">
                <a href="menu_selengkapnya_kl/jenis_lantai.php"><i class="bi bi-chevron-double-right"> Lihat Lebih Lengkap</i></a>
            </div>
            <br>

            <!-- JENIS JENIS LAMPU -->
            <div class="judularea">
                <h3>JENIS JENIS LAMPU</h3>
                <hr>
            </div>
            <?php  
            $get = mysqli_query($c, "SELECT * FROM produk WHERE deskripsi='LAMPU' LIMIT 4");
            while ($p=mysqli_fetch_array($get)) {
                $namaproduk = $p['namaproduk'];
                $deskripsi = $p['deskripsi'];
                $hargaproduk = $p['harga'];
            ...
            ?>
            <br>
            <!-- menu selengkapnya JENIS JENIS LAMPU -->
            <div class="menuselengkapnya">
                <a href="#"><i class="bi bi-chevron-double-right"> Lihat Lebih Lengkap</i></a>
            </div>
            <br>

            <!-- JENIS JENIS TALI NILON -->
            <div class="judularea">
                <h3>JENIS-JENIS TALI NILON</h3>
                <hr>
            </div>
            <?php  
            $get = mysqli_query($c, "SELECT * FROM produk WHERE deskripsi='NILON' LIMIT 4");
            while ($p=mysqli_fetch_array($get)) {
                $namaproduk = $p['namaproduk'];
                $deskripsi = $p['deskripsi'];
                $hargaproduk = $p['harga'];
            ...
            ?>
            <br>
            <!-- menu selengkapnya JENIS-JENIS TALI NILON -->
            <div class="menuselengkapnya">
                <a href="menu_selengkapnya_kl/jenis_nilon.php"><i class="bi bi-chevron-double-right"> Lihat Lebih Lengkap</i></a>
            </div>
            <br>

            <!-- JENIS-JENIS LEM -->
            <div class="judularea">
                <h3>JENIS-JENIS LEM</h3>
                <hr>
            </div>
            <?php  
            $get = mysqli_query($c, "SELECT * FROM produk WHERE deskripsi='LEM' LIMIT 4");
            while ($p=mysqli_fetch_array($get)) {
                $namaproduk = $p['namaproduk'];
                $deskripsi = $p['deskripsi'];
                $hargaproduk = $p['harga'];
            ...
            ?>
            <br>
            <!-- menu selengkapnya JENIS-JENIS LEM -->
            <div class="menuselengkapnya">
                <a href="menu_selengkapnya_kl/jenis_lem.php"><i class="bi bi-chevron-double-right"> Lihat Lebih Lengkap</i></a>
            </div>
            <br>
        ...
        <div>
                <ul class="pagination justify-content-center">
                    ...
                    <li class="page-item disabled"><a class="page-link" href="pagination_kolono_timur/pagination2.php">1</a></li>
                    <li class="page-item"><a class="page-link" href="pagination_kolono_timur/pagination2.php">2</a></li>
                    <li class="page-item"><a class="page-link" href="pagination_kolono_timur/pagination3.php">3</a></li>
                    <li class="page-item"><a class="page-link" href="pagination_kolono_timur/pagination2.php">Next</a></li>
                </ul>
        </div>
        <br>
        <br>
